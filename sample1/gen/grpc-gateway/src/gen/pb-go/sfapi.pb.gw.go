...
// RegisterStarfriendsHandlerClient registers the http handlers for service Starfriends
// to "mux". The handlers forward requests to the grpc endpoint over the given implementation of "StarfriendsClient".
